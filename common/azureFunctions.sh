...
az_logout() {
  ...
  echo -e "\n"
  echo "*****************************************************************************************************"
  echo !!!!! `date +%Y%m%d.%T` ending and az logout job ver ${version}, service $dockerType  !!!!!
  echo "*****************************************************************************************************"
  echo -e "\n"
# Logout
az logout
...
get_connection() {
  ...
  if [ $dockerType = "azsql" ]; then # If is Azure SQL
      if [ $useFQDN = "NO" ]; then
  ...
  if [ $dockerType = "cosmosmg" ]; then # If is Cosmos DB
      if [ $useFQDN = "NO" ]; then
  ...
  if [ $dockerType = "postgresql" ]; then # If is postgre DB
  ...
  if [ $dockerType = "blobstorage" ]; then # If is blobstorage
          if [ $azureResources_useAutoDiscover = "YES" ]; then
                  echo
  ...
  if [ $dockerType = "adls" ]; then # If is adls
